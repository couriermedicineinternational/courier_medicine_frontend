                  ...
                  <div>
                    ...
                    <div className="flex">
                      <select 
                        ...
                        className="w-[85px] px-2 py-2.5 rounded-l-xl border border-r-0 border-slate-200 bg-slate-100 text-xs font-semibold text-slate-800 focus:outline-none focus:ring-1 focus:ring-secondary/20 z-10"
                      >
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-r-xl border border-slate-200 bg-slate-50/50 text-xs font-semibold text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary transition-all"
                      />
                    </div>
