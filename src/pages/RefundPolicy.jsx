...
export default function RefundPolicy() {
  ...
  useEffect(() => {
    ...
    const loadPolicy = async () => {
      try {
        ...
        console.error('Error fetching Refund Policy content:', err);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const displayTitle = policy?.title || "Refund Policy";
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-white z-10">
              ...
              >
                ...
                <nav className="text-xs md:text-sm font-semibold tracking-wide flex items-center gap-2 text-white/80">
                  ...
                  <span className="text-[#03ADA4] font-bold">Refund Policy</span>
                </nav>
              </motion.div>
            </div>
          </div>
