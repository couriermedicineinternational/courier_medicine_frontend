...
export default function MobileBottomNav() {
  ...
  return (
    <div className="lg:hidden md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#eaeaea] border-t border-slate-300/80 py-2.5 px-2 flex items-center justify-around shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      {/* Home */}
      <Link 
        to="/" 
        className="flex flex-col items-center gap-1 text-center"
      >
        <Home size={20} className="text-[#0052cc] stroke-[2px]" />
        <span className="text-[10px] font-bold tracking-wide text-slate-900 mt-0.5">Home</span>
      </Link>
      ...
      <Link 
        ...
        className="flex flex-col items-center gap-1 text-center"
      >
        <Banknote size={20} className="text-[#0052cc] stroke-[2px]" />
        <span className="text-[10px] font-bold tracking-wide text-slate-900 mt-0.5">Courier Charges</span>
      </Link>
      ...
      <a 
        ...
        className="flex flex-col items-center gap-1 text-center"
      >
        <svg viewBox="0 0 24 24" width="20" height="20" className="text-[#25D366] fill-current">
        ...
        <span className="text-[10px] font-bold tracking-wide text-slate-900 mt-0.5">Whatsapp</span>
      </a>
      ...
      <a 
        ...
        className="flex flex-col items-center gap-1 text-center"
      >
        <Phone size={20} className="text-[#0052cc] stroke-[2px]" />
        <span className="text-[10px] font-bold tracking-wide text-slate-900 mt-0.5">Call Us</span>
      </a>
    </div>
  );
}
